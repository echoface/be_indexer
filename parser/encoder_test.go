...
func TestExactTermEncoderUsesTokenizerInBothDirections(t *testing.T) {
	enc, err := NewPredicateEncoder("age", core.FieldOption{IndexType: core.IndexNameDefault, Encoder: "number"})
	if err != nil {
		t.Fatal(err)
	}
...
func TestRangeEncoderBuildAndQuery(t *testing.T) {
	enc, err := NewPredicateEncoder("age", core.FieldOption{IndexType: core.IndexNameExtendRange, Encoder: core.IndexNameExtendRange})
	if err != nil {
		t.Fatal(err)
	}
...
func TestACEncoderBuildAndQuery(t *testing.T) {
	enc, err := NewPredicateEncoder("keyword", core.FieldOption{IndexType: core.IndexNameACMatcher, Encoder: core.IndexNameACMatcher})
	if err != nil {
		t.Fatal(err)
	}
